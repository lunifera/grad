...
package com.lunifera.graduate.ui.validator;
...
public class BeanValidator implements Validator {
	 ...
	 */
	public BeanValidator(ValidatorFactory validatorFactory, Class<?> beanClass,
			String propertyName) {
		this.validatorFactory = validatorFactory;
		this.javaxBeanValidator = validatorFactory.getValidator();
	...
	public void validate(final Object value) throws InvalidValueException {
		...
		if (violations.size() > 0) {
			...
			for (Object v : violations) {
				...
				String msg = validatorFactory.getMessageInterpolator()
						.interpolate(
